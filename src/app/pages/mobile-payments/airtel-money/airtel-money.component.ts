...
@Component({
  selector: 'app-airtel-money',
  templateUrl: './airtel-money.component.html',
  styleUrls: ['./airtel-money.component.scss'],
  providers: [TransactionsService, DecimalPipe],
})
export class AirtelMoneyComponent implements OnInit, OnDestroy {
  // Breadcrumb data
  ...
  ngOnInit() {
    ...
    this.breadCrumbItems = [
      ...
      {
        label: 'Airtel Money Transactions',
        path: '/',
        active: true,
      },
    ];
  ...
  _fetchData(): void {
    this.transactionsService._fetchTransactions(50);
