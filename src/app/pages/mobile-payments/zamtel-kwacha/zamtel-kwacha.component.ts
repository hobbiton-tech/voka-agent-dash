...
@Component({
  selector: 'app-zamtel-kwacha',
  templateUrl: './zamtel-kwacha.component.html',
  styleUrls: ['./zamtel-kwacha.component.scss'],
  providers: [TransactionsService, DecimalPipe],
})
export class ZamtelKwachaComponent implements OnInit, OnDestroy {
  // Breadcrumb data
  ...
  ngOnInit() {
    ...
    this.breadCrumbItems = [
      ...
      {
        label: 'Zamtel Kwacha Transactions',
        path: '/',
        active: true,
      },
    ];
  ...
  _fetchData(): void {
    this.transactionsService._fetchTransactions(52);
