...
@Component({
  selector: 'app-topstar-transactions',
  templateUrl: './topstar-transactions.component.html',
  styleUrls: ['./topstar-transactions.component.scss'],
  providers: [TransactionsService, DecimalPipe],
})
export class TopstarTransactionsComponent implements OnInit, OnDestroy {
  // Bread crumb data
  ...
  _fetchData(): void {
    this.transactionsService._fetchTransactions(7);
