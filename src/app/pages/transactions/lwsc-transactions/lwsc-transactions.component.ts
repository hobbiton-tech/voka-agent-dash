...
@Component({
  selector: 'app-lwsc-transactions',
  templateUrl: './lwsc-transactions.component.html',
  styleUrls: ['./lwsc-transactions.component.scss'],
  providers: [TransactionsService, DecimalPipe],
})
export class LwscTransactionsComponent implements OnInit, OnDestroy {
  // Bread crumb data
  ...
  _fetchData(): void {
    this.transactionsService._fetchTransactions(8);
