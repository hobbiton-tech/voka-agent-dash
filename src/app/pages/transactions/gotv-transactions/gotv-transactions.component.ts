...
@Component({
  selector: 'app-gotv-transactions',
  templateUrl: './gotv-transactions.component.html',
  styleUrls: ['./gotv-transactions.component.scss'],
  providers: [TransactionsService, DecimalPipe],
})
export class GotvTransactionsComponent implements OnInit, OnDestroy {
  // Bread crumb data
  ...
  _fetchData(): void {
    this.transactionsService._fetchTransactions(6);
