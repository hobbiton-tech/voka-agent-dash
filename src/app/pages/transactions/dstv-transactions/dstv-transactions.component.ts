...
@Component({
  selector: 'app-dstv-transactions',
  templateUrl: './dstv-transactions.component.html',
  styleUrls: ['./dstv-transactions.component.scss'],
  providers: [TransactionsService, DecimalPipe],
})
export class DstvTransactionsComponent implements OnInit, OnDestroy {
  // Bread crumb data
  ...
  _fetchData(): void {
    this.transactionsService._fetchTransactions(5);
